    ...
    public partial class InitialModel : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Discounts",
                columns: new[] { "Id", "Currency", "DiscountType", "PercentageId", "Price", "typeOfCustomerId" },
                values: new object[,]
                {
                    { 1, "USD($)", "Affiliate", 1, 0.1m, null },
                    { 2, "USD($)", "Employee", 2, 0.3m, null },
                    { 3, "USD($)", "CustomerOverTwoYears", 3, 0.05m, null }
                });
